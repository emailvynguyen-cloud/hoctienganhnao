    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-2 bg-white dark:bg-slate-900 p-2 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-2xs overflow-x-auto">
        <button
          ...
          className={`h-10 px-4 rounded-xl text-xs font-bold transition flex items-center shrink-0 cursor-pointer ${
        ...
        >
          <Bell className="w-4 h-4 mr-1.5" /> Chấm Bài Tập (Feedback)
        </button>
