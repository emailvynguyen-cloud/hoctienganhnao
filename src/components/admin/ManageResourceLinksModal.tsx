...
export const ManageResourceLinksModal: React.FC<ManageResourceLinksModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-md animate-fadeIn">
      <div className="bg-white dark:bg-slate-900 rounded-3xl border-2 border-pink-300 dark:border-slate-800 max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col relative text-slate-800 dark:text-white shadow-2xl">
        
        {/* HEADER - Fixed Top */}
        <div className="p-4 sm:p-6 border-b border-pink-100 dark:border-slate-800 flex items-center justify-between shrink-0 bg-slate-50 dark:bg-slate-800/80">
          <div className="flex items-center space-x-3 pr-6">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-pink-400 to-rose-400 text-white flex items-center justify-center font-black text-xl shadow-md shrink-0">
              📁
            </div>
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">
                Thêm, sửa, xóa, sắp xếp và ẩn/hiện các liên kết giáo trình
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 p-4 sm:p-6 overflow-y-auto space-y-6 text-xs font-medium min-h-0">
          {/* Add / Edit Form Box */}
