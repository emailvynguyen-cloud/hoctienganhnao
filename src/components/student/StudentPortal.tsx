      ...
      {(() => {
        ...
        return (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* STAT CARD 2: TOTAL EXCUSED ABSENCES */}
            <div
              onClick={() => setIsAbsenceDetailsModalOpen(true)}
              className="p-5 rounded-2xl bg-gradient-to-r from-sky-100/90 via-blue-50/80 to-indigo-50/90 dark:from-sky-950/40 dark:to-slate-800 border border-sky-200/80 dark:border-sky-900/60 shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition duration-200 cursor-pointer flex items-center justify-between group"
              title="Bấm để xem danh sách chi tiết tất cả buổi nghỉ học có phép"
            >
              <div className="space-y-1">
                <span className="text-xs font-extrabold text-sky-900 dark:text-sky-300 tracking-tight uppercase block">
                  Tổng số buổi nghỉ có phép
                </span>
                <span className="text-2xl sm:text-3xl font-black text-sky-950 dark:text-sky-100 block">
                  {excusedAbsences.length} buổi
                </span>
              </div>
              <div className="w-12 h-12 rounded-2xl bg-sky-500/20 text-sky-900 dark:text-sky-300 flex items-center justify-center font-black text-2xl shrink-0 group-hover:scale-110 transition duration-200">
                🗓️
              </div>
            </div>
