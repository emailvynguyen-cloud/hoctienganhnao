        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-2xl bg-emerald-100 hover:bg-emerald-200 text-emerald-950 border border-emerald-200 font-extrabold text-xs transition flex items-center shadow-xs"
              title="Hướng dẫn Thêm App ra Màn Hình Chính Điện Thoại"
            >
              <Smartphone className="w-3.5 h-3.5 mr-1.5 text-emerald-600 animate-bounce" />
            ...
            <button
              ...
              className="relative group px-4 py-2 rounded-2xl bg-gradient-to-r from-pink-200 via-rose-100 to-sky-200 text-pink-950 font-black text-xs transition-all duration-300 shadow-xs hover:shadow-md hover:scale-105 flex items-center space-x-1.5 border border-pink-300 overflow-hidden"
              title="Xem Bảng Thành Tích Thi Đua Vinh Danh"
            >
              <div className="w-5 h-5 rounded-full bg-white/60 flex items-center justify-center shrink-0">
            ...
            {!activePublicHash && (
              <>
                ...
                {currentUser ? (
                  <div className="flex items-center space-x-2 bg-pink-50/70 dark:bg-slate-800 p-1.5 rounded-2xl border border-pink-200">
                    ...
                    {currentUser.role === 'super_admin' && (
                      <button
                        ...
                        className="px-2.5 py-1.5 rounded-xl bg-pink-200 text-pink-950 font-extrabold text-xs hover:bg-pink-300 transition shadow-xs border border-pink-300"
                  ...
                  <button
                    onClick={onOpenLogin}
                    className="px-4 py-2 rounded-2xl bg-gradient-to-r from-pink-300 via-rose-200 to-sky-200 text-pink-950 font-extrabold text-xs hover:from-pink-400 hover:to-sky-300 transition shadow-xs border border-pink-300 flex items-center"
                  >
                    <LogIn className="w-4 h-4 mr-1.5 text-pink-700" /> Đăng Nhập Hệ Thống
                  </button>
                )}
              </>
            )}
