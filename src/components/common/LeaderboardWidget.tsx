        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 relative z-10">
          ...
          <div className="flex items-center space-x-2">
            ...
            {onClose && (
              ...
              >
                <ArrowLeft className="w-4 h-4 mr-1.5" /> Thoát
              </button>
            )}
          </div>
        </div>
          ...
          return (
            <div
              ...
              className={`p-4 rounded-3xl border transition-all duration-300 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm ${
                isTop1
                  ? 'bg-gradient-to-r from-amber-500/15 via-amber-100/50 to-pink-50 border-amber-300 shadow-md ring-2 ring-amber-300/40'
                  : isTop2
